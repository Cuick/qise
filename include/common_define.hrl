...
-define(MIN_PET_ID,10000000000000).

%%生物阵营
-define(FACTION_NORMAL_MAN,0).
%%人物移动
-define(BASE_MOVE_SPEED,8).	
-define(MOVE_ASYNC_NUM,3).
-define(MOVE_MAX_DEALY_TIME,500).
-define(MOVE_CHEAT_THREAT,20).
-define(MOVE_CHEAT_THREAT_TRANSPORTATION, 5).
...
%%阵营战类型
-define(CAMP_BATTLE_35_49,1).
-define(CAMP_BATTLE_50_100,2).
...
-define(SKILL_SHIFT_POS, 800000001).
-define(PULL_OR_PUSH_DELAY, 300).

-define (TRAVEL_BATTLE_LINE_ID, -2).
