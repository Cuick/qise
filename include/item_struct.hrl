...
set_protoinfo_to_iteminfo(Iteminfo,{_,Entry,Name,Class,Displayed,Equipmentset,Level,Qualty,Requiredlevel,			%%FK 26!!!!
							...
							Bonding,Maxsocket,Scripts,Questid,Baserepaired,Overdue_type,_Overdueargs,_Overduetransform,_EnchantExt, _UseCondition})->
				Iteminfo#item_info{
				template_id = Entry,
				name	= Name,
				class	= Class,
...
set_id_to_iteminfo(Iteminfo, Id) ->
	Iteminfo#item_info{id = Id}.
