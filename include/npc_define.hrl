...
-define(NPC_FUNCTION_WEDDING_REGISTER,37).          %% wedding register
-define(NPC_FUNCTION_WEDDING_CEREMONY,38).          %% wedding ceremony
-define(NPC_FUNCTION_WEDDING_CRUISE,39).            %% wedding cruise
-define(NPC_FUNCTION_WEDDING_DIVORCE,40).           %% wedding divorce
-define(NPC_FUNCTION_ITEM_TRADE,41).                %% 道具兑换
-define(NPC_FUNCTION_GOD_TREE,42).                %% 七色神树
