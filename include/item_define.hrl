...
-define(ITEM_TYPE_SKILL_BOOK,130).						%%技能书
														%%50资质上限提升道具
-define(ITEM_TYPE_PET_EXP,92).
-define(ITEM_TYPE_PET_UP,132).
-define(ITEM_TYPE_PET_EGG,131).
...
-define(ITEM_TYPE_BANQUET_SOAP,77).							%%搓澡肥皂
-define(ITEM_TYPE_TREASURE_TRANSPORT_FRESH,78).			%%刷镖令
-define(ITEM_TYPE_ADD_INTIMACY,79).                     %% add intimacy
...
-define(ITEM_TYPE_OPEN_CHARGE_FEEDBACK,92).
