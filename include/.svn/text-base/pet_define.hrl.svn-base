...
-define(PET_ATTACK_TIME,800).		%%攻击间隔
...
-define(MAX_PETNAME_LEN,15).		%%最长宠物名
...
-define(PET_MAX_HAPPINESS,1000).	%%最大快乐度

-define(PET_MIN_QUALITY,1).			%%最低品质
...
-define(PET_TOTAL_SKILL_SLOT,8).			%%宠物技能槽位
-define(PET_BORN_SKILL_SLOT,2).				%%天生技能槽位
-define(PET_COMMON_SKILL_SLOT,0).			%%普通攻击技能槽位


-define(PET_SKILL_SLOT_NOT_OPEN,-1). 	    %%技能槽位未开启
-define(PET_SKILL_SLOT_INACTIVE,0).			%%技能槽位开启empty
-define(PET_SKILL_SLOT_ACTIVE,1).			%%技能槽位开启not_empty
...
-define(PET_SHOP_REFRESH_TIME, 3600).		% 宠物商店刷新时间间隔
