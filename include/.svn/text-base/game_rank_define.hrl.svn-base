...
-define(RANK_TYPE_LOOP_TOWER_MASTER,3).		%%challenge
-define(RANK_TYPE_MAGIC_POWER,4).
-define(RANK_TYPE_RANGE_POWER,5).
-define(RANK_TYPE_FIGHTING_FORCE,6).
-define(RANK_TYPE_ROLE_TANGLE_KILL,7).
-define(RANK_TYPE_LOOP_TOWER_NUM,8).		%%challenge
-define(RANK_TYPE_ANSWER,9).
-define(RANK_TYPE_CHESS_SPIRITS_SINGLE,10).        %%challenge
-define(RANK_TYPE_CHESS_SPIRITS_TEAM,11).        %%challenge
-define(RANK_TYPE_PET_TALENT_SCORE,12).        %%challenge
-define(RANK_TYPE_MAIN_LINE,13).				%%challenge
...
-define(RANK_ANSWER_TOTLE_NUM,10).
