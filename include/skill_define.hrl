%%SKILL TYPE
-define(SKILL_TYPE_NOMAL,0).					    %%0: 普通攻击
...
-define(SKILL_TYPE_ACTIVE_WITHOUT_CHECK_SILENT,9).	%%9: 无视沉默的主动技能(用在补血补篮技能中)
-define(SKILL_TYPE_PICKUP_BUFF,10).                 %%10: BUFF 拾取技能
-define(SKILL_TYPE_SHIFT,11).                       %%11: 瞬移技能
-define(SKILL_TYPE_PUSH,12).                        %%12: 推技能
-define(SKILL_TYPE_PULL,13).                        %%13: 拉技能
-define(SKILL_TYPE_EQUIPMENT,14).                   %%14: 拾取装备
...
-define(BUFF_IMMUNE_CTRL,12).                   %%免疫控制
-define(BUFF_IMMUNE_SKILL,13).                  %%免疫技能效果
-define(BUFF_HOLD,14).                          %%无法闪现
