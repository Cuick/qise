...
start_battle()->
	...
	MapProc = guild_battle,
	CreatorTag = {?CREATOR_LEVEL_BY_SYSTEM,?CREATOR_BY_SYSTEM},
	Extra = {atom_to_list(MapProc),?GUILDBATTLE_INSTANCEID},
	case rpc:call(Node,map_manager,start_instance,[MapProc, MapId, instance, CreatorTag, Extra]) of
		ok->
...
battle_over()->
	...
	% 失去七色国主称号	
    title_op:lose_guild_battle_title(),
    % 获得七色国主称号
	title_op:guild_battle_title(RoleId),
	%%
