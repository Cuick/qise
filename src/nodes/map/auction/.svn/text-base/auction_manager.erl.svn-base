...
-export([apply_up_stall/2,apply_recede_item/2,stalls_search/4,stall_detail/2,apply_buy_item/4,
		 stall_detail_myself/2,stall_rename/2,stall_detail_by_rolename/2,apply_all_auctions_down/0]).
