...
stop()->
	...
	broad_cast_to_blue({dragon_fight_stop,get(blue_dragon_buff),?DRAGON_FIGHT_FACTION_BLUE}),
	broad_cast_to_red({dragon_fight_stop,get(red_dragon_buff),?DRAGON_FIGHT_FACTION_RED}),
