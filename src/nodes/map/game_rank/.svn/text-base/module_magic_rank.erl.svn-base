...
-define(MAGIC_LOST_LIST,magic_lost_list).
%%
%% Exported Functions
%%
...
%%
load_from_data(Data) ->
	game_rank_collect_util:load_from_data(Data,?MAGIC_RANK_LIST,?MAGIC_TOP_LIST,?RANK_FRESH_MAGIC_LIST,
		?COLLECT_MAGIC_LIST,?RANK_TYPE_MAGIC_POWER).
...
gather(RoleId,Attack)->
	game_rank_collect_util:gather(RoleId,Attack,?MAGIC_RANK_LIST,?MAGIC_TOP_LIST,?RANK_FRESH_MAGIC_LIST,
		?COLLECT_MAGIC_LIST,?RANK_TYPE_MAGIC_POWER,?MAGIC_LOST_LIST).

refresh_gather()->
	game_rank_collect_util:refresh_gather(?MAGIC_RANK_LIST,?MAGIC_TOP_LIST,?RANK_FRESH_MAGIC_LIST,
		?COLLECT_MAGIC_LIST,[],?MAGIC_LOST_LIST).
