...
-export([challenge/3,gather/3,watch_rank/2,
		 ...
		 get_main_line_rank_top_role/3,on_role_change_name/2,sync_get_fighting_force_rank/1,sync_get_chess_spirits_single/1]).
...
sync_get_fighting_force_rank(RoleId)->
	try
		global_util:call(?MODULE,{sync_get_fighting_force_rank,RoleId})
	catch
		E:R->
			slogger:msg("sync_get_level_rank RoleId ~p ~p ~p ~n",[RoleId,E,R]),
			[]
...
sync_get_chess_spirits_single(RoleId)->
    try
        global_util:call(?MODULE,{sync_get_chess_spirits_single,RoleId})
    catch
        E:R->
            slogger:msg("sync_get_level_rank RoleId ~p ~p ~p ~n",[RoleId,E,R]),
            []
...
handle_call({sync_get_fighting_force_rank,RoleId},_From, State) ->
	Reply = module_fighting_force_rank:search_rank(RoleId),
    {reply, Reply, State};
...
handle_call({sync_get_chess_spirits_single,RoleId},_From, State) ->
    Reply = module_chess_spirits_single_rank:search_rank(RoleId),
    {reply, Reply, State}.
%% --------------------------------------------------------------------
