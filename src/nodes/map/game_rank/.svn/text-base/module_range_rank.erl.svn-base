...
-define(RANGE_LOST_LIST,range_lost_list).
%%
%% Exported Functions
%%
-export([load_from_data/1,can_challenge_rank/1,challenge_rank/2,send_rank_list/1,
		 gather/2,refresh_gather/0,is_top/1,after_gather/0]).

%%
%% API Functions
%%
load_from_data(Data) ->
	game_rank_collect_util:load_from_data(Data,?RANGE_RANK_LIST,?RANGE_TOP_LIST,?RANK_FRESH_RANGE_LIST,
		?COLLECT_RANGE_LIST,?RANK_TYPE_RANGE_POWER).
...
gather(RoleId,Attack)->
	game_rank_collect_util:gather(RoleId,Attack,?RANGE_RANK_LIST,?RANGE_TOP_LIST,?RANK_FRESH_RANGE_LIST,
		?COLLECT_RANGE_LIST,?RANK_TYPE_RANGE_POWER,?RANGE_LOST_LIST).

refresh_gather()->
	game_rank_collect_util:refresh_gather(?RANGE_RANK_LIST,?RANGE_TOP_LIST,?RANK_FRESH_RANGE_LIST,
		?COLLECT_RANGE_LIST,[],?RANGE_LOST_LIST).
