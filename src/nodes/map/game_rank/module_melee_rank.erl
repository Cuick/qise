...
-define(MELEE_LOST_LIST,melee_lost_list).
%%
%% Exported Functions
%%
...
%%
load_from_data(Data) ->
	game_rank_collect_util:load_from_data(Data,?MELEE_RANK_LIST,?MELEE_TOP_LIST,?RANK_FRESH_MELEE_LIST,
		?COLLECT_MELEE_LIST,?RANK_TYPE_MELLE_POWER).
...
gather(RoleId,Attack)->
	game_rank_collect_util:gather(RoleId,Attack,?MELEE_RANK_LIST,?MELEE_TOP_LIST,?RANK_FRESH_MELEE_LIST,
		?COLLECT_MELEE_LIST,?RANK_TYPE_MELLE_POWER,?MELEE_LOST_LIST).

refresh_gather()->
	game_rank_collect_util:refresh_gather(?MELEE_RANK_LIST,?MELEE_TOP_LIST,?RANK_FRESH_MELEE_LIST,
		?COLLECT_MELEE_LIST,[],?MELEE_LOST_LIST).
