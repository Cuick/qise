...
on_check()->
	...
	camp_battle_manager_op:on_check(),
...
on_start_battle(?CAMP_BATTLE)->
	    camp_battle_manager_op:on_start_battle();
...
on_battle_end(?CAMP_BATTLE)->
    camp_battle_manager_op:on_battle_end();
...
apply_for_battle({?CAMP_BATTLE,Info})->
    camp_battle_manager_op:apply_for_battle(Info);
...
cancel_apply_battle({?CAMP_BATTLE,Info})->
    camp_battle_manager_op:cancel_apply_battle(Info);
...
battle_start_notify({?CAMP_BATTLE,Info})->
    camp_battle_manager_op:battle_start_notify(Info);
...
notify_manager_battle_start({?CAMP_BATTLE,Info})->
    camp_battle_manager_op:notify_manager_battle_start(Info);
...
get_camp_battle_last_record(RoleId)->
	camp_battle_manager_op:get_camp_battle_last_record(RoleId).

get_camp_battle_player_num(RoleId)->
	camp_battle_manager_op:get_camp_battle_player_num(RoleId).
...
get_role_battle_kill_info({?CAMP_BATTLE,Info})->
    camp_battle_manager_op:get_role_battle_kill_info(Info);
...
notify_manager_role_leave({?CAMP_BATTLE,Info})->
	camp_battle_manager_op:role_leave_battle(Info);
...
check_battle_time(?CAMP_BATTLE)->
    camp_battle_manager_op:check_battle_time();
