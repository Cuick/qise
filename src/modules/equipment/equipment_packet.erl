...
process_equipment(#equipment_stone_remove_c2s{equipment=Equipment,socknum=SockNum})->
    equipment_op:equipment_stone_remove(Equipment,SockNum);
process_equipment(#equipment_stonemix_c2s{stonelist=StoneSlotList})->
	equipment_op:equipment_stonemix(StoneSlotList);

%%批量合成功能,前端叫equipment_stonemix_c2s
process_equipment(#equipment_stonemix_bat_c2s{stoneSlot=StoneSlot,numRequire=NumRequire,numMix=NumMix})->
	equipment_op:equipment_stonemix_batch(StoneSlot,NumRequire,NumMix);


process_equipment(#equipment_upgrade_c2s{equipment=Equipment,upgrade=Upgrade})->
	equipment_upgrade:equipment_upgrade(Equipment,Upgrade);
...
process_equipment(#equipment_remove_seal_c2s{equipment=Equipment,reseal=ItemSlot})-> 
	equipment_remove_seal:equipment_remove_seal(Equipment,ItemSlot);
