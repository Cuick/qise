...
-define(NPC_PROTO_ETS,creature_proto_ets).
-define(NPC_SPAWNS_ETS,creature_spawns_ets).
...
create()->
	ets:new(?NPC_PROTO_ETS, [public,set,named_table]),
	ets:new(?NPC_SPAWNS_ETS, [public,set,named_table]).
