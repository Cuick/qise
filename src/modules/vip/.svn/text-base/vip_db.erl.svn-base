...
async_update_vip_role_to_mnesia(RoleId,VipRole) when is_record(VipRole, vip_role)->
	dmp_op:async_write(RoleId,VipRole);
...
sync_update_vip_role_to_mnesia(_RoleId,VipRole) when is_record(VipRole, vip_role)->
	dal:write_rpc(VipRole);
