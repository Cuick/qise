...
save_role_instance_info(RoleId,Info, Ext, Quality)->
	TableName = db_split:get_owner_table(role_instance_quality, RoleId),
	dmp_op:sync_write(RoleId,{TableName,RoleId,Info, Ext, Quality}).

async_save_role_instance_info(RoleId,Info, Ext, Quality)->
	TableName = db_split:get_owner_table(role_instance_quality, RoleId),
	dmp_op:async_write(RoleId,{TableName,RoleId,Info, Ext, Quality}).
