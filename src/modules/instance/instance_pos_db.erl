...
reg_instance_pos_to_mnesia(Instanceid,Creation,StartTime,CanJoin,Node,Proc,MapId,Protoid,Members)->
	travel_battle_util:cast_for_all_server_with_self_if_share_node(?MODULE,reg_instance_pos_to_db,[Instanceid,Creation,StartTime,CanJoin,Node,Proc,MapId,Protoid,Members]).

unreg_instance_pos_to_mnesia(Instanceid)->
	travel_battle_util:cast_for_all_server_with_self_if_share_node(?MODULE,unreg_instance_pos_from_db,[Instanceid]).
