...
hook_on_trans_map_by_node(NewMapinfo)->
	...
	case travel_battle_util:is_travel_battle_map(NewMapId) of
		true ->
...
hook_on_trans_map_faild()->
	...
	case travel_battle_util:is_travel_battle_map(MapId) of 
		true->
...
is_same_source_role(RoleId)->
	lists:member(travel_battle_util:get_serverid_by_roleid(RoleId), get(source_servers_ids)).
