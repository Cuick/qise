...
%%% Description : 操作protobuffer生成的record的函数
...
to_skill_info(SkillID,SkillLevel,LastCastTime)->
	...
	LeftTime = (CoolDown - trunc(timer:now_diff(Now,LastCastTime)/1000)),
	#s{skillid=SkillID, level=SkillLevel,lefttime = erlang:max(0, erlang:min(CoolDown, LeftTime))}.
