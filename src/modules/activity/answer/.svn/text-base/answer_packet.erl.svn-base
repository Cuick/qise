...
%%
-export([handle/2]).
-export([encode_answer_sign_notice_s2c/1,encode_answer_sign_success_s2c/0,encode_answer_start_notice_s2c/4,
...
encode_answer_start_notice_s2c(Id, Num, Double, Auto)->
	login_pb:encode_answer_start_notice_s2c(#answer_start_notice_s2c{id = Id, num = Num, double = Double, auto = Auto}).
