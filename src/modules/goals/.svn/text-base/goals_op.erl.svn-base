...
init_role_goals()->
	...
	achieve_op:achieve_update({level},[0],role_op:get_level_from_roleinfo(RoleInfo)),
	achieve_op:achieve_update({pet_level},[0],pet_level_op:get_pet_max_level()),
	achieve_op:achieve_update({guildposting},[0],guild_util:get_guild_posting()),
	achieve_op:achieve_update({venation},[0],venation_op:get_total_active_points()),
	achieve_op:achieve_update({venation_advance},[0],venation_op:get_max_venation_advance()).
