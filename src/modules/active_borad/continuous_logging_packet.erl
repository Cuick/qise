...
encode_continuous_logging_board_s2c(NormalAwardDayList, VipAwardDay, Days)->
	login_pb:encode_continuous_logging_board_s2c(#continuous_logging_board_s2c{normalawardday=NormalAwardDayList,vipawardday=VipAwardDay,days=Days}).

encode_continuous_opt_result_s2c(Result)->
	login_pb:encode_continuous_opt_result_s2c(#continuous_opt_result_s2c{result = Result}).
