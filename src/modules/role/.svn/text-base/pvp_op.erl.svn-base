...
can_be_attack(SelfInfo,TargetInfo) when (is_record(TargetInfo , gm_pet_info))->
  	false;
% 40-60级vip地图，不许pk
can_be_attack(SelfInfo,TargetInfo) 
				when (SelfInfo#gm_role_info.gs_system_map_info#gs_system_map_info.map_id =:= 1205) ->
	false;
% 60-80级vip地图，不许pk
can_be_attack(SelfInfo,TargetInfo) 
				when  (SelfInfo#gm_role_info.gs_system_map_info#gs_system_map_info.map_id =:= 1206) ->
	false;
%% travel battle
can_be_attack(SelfInfo,TargetInfo) 
				when  (SelfInfo#gm_role_info.gs_system_map_info#gs_system_map_info.map_id =:= 6004) ->
	true;
can_be_attack(SelfInfo,TargetInfo) 
				when  (SelfInfo#gm_role_info.gs_system_map_info#gs_system_map_info.map_id =:= 9000) ->
	true;
