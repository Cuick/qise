...
to_role_attribute({vip_expr, Expr}) ->
    pb_util:key_value(?ROLE_ATTR_VIP_EXPR, Expr);
	...
	case is_integer(State) of
		...
		_->	
			case State of
				...
				dancing ->
					CreatureState = ?CREATURE_STATE_DANCING;
				_->
...
to_role_attribute({pet_criticaldamage,Value})->
  pb_util:key_value(?ROLE_ATTR_PET_CRITICALDAMAGE,Value);
...
to_role_attribute({pet_grade,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_GRADE,Value);

to_role_attribute({pet_savvy,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_SAVVY,Value);

to_role_attribute({pet_dodge,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_DODGE,Value);

to_role_attribute({pet_defense,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_DEFENSE,Value);

to_role_attribute({pet_defense1,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_DEFENSE1,Value);

to_role_attribute({pet_life,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_LIFE,Value);

to_role_attribute({pet_quality_value_power,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_QUALITY_VALUE_POWER,Value);

to_role_attribute({pet_gender,Value}) ->
	pb_util:key_value(?ROLE_ATTR_PET_GENDER,Value);


to_role_attribute({defense,Value})->
    pb_util:key_value(?ROLE_ATTR_DEFENSE,Value);

to_role_attribute({life,Value})->
    pb_util:key_value(?ROLE_ATTR_LIFE,Value);

to_role_attribute({pet_quality_value_hitrate,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_QUALITY_VALUE_HITRATE,Value);

to_role_attribute({pet_quality_value_dodge,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_QUALITY_VALUE_DODGE,Value);

to_role_attribute({pet_quality_value_criticalrate,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_QUALITY_VALUE_CRITICALRATE,Value);

to_role_attribute({pet_quality_value_life,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_QUALITY_VALUE_LIFE,Value);

to_role_attribute({pet_quality_value_defense,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_QUALITY_VALUE_DEFENSE,Value);

to_role_attribute({pet_quality_value_up,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_QUALITY_VALUE_UP,Value);

to_role_attribute({pet_grade_riseup_lucky,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_GRADE_RISEUP_LUCKY,Value);

to_role_attribute({pet_quality_riseup_lucky,Value})->
    pb_util:key_value(?ROLE_ATTR_PET_QUALITY_RISEUP_LUCKY,Value);

to_role_attribute({pet_stage, Value})->
    pb_util:key_value(?ROLE_ATTR_PET_STAGE, Value);

to_role_attribute({pet_magic_defense, Value})->
    pb_util:key_value(?ROLE_ATTR_PET_MAGIC_DEFENSE, Value);

to_role_attribute({pet_far_defense, Value})->
    pb_util:key_value(?ROLE_ATTR_PET_FAR_DEFENSE, Value);

to_role_attribute({pet_near_defense, Value})->
    pb_util:key_value(?ROLE_ATTR_PET_NEAR_DEFENSE, Value);

to_role_attribute({pet_magic_immunity, Value})->
    pb_util:key_value(?ROLE_ATTR_PET_MAGIC_IMMUNITY, Value);

to_role_attribute({pet_far_immunity, Value})->
    pb_util:key_value(?ROLE_ATTR_PET_FAR_IMMUNITY, Value);

to_role_attribute({pet_near_immunity, Value})->
    pb_util:key_value(?ROLE_ATTR_PET_NEAR_IMMUNITY, Value);
...
to_role_attribute({vip_soulpower,SoulPower})->
    pb_util:key_value(?ROLE_ATTR_VIP_SOULPOWER,SoulPower);
...
to_role_attribute({dancing_role,RoleId}) ->
	pb_util:key_value(?ROLE_ATTR_DANCING_ROLE, RoleId);

to_role_attribute({spouse,RoleId}) ->
	pb_util:key_value(?ROLE_ATTR_SPOUSE, RoleId);
