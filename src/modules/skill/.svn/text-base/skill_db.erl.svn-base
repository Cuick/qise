...
-define(PET_SKILL,[920000001,920000002,920000003,920000004,920000005,920000006,920000007]).
...
-export([get_role_skill_info/1,get_skill_info/2,change_role_skill_level/3,save_role_skill_info/1,is_skill_studied/2,get_skill_level/2,
		...
		async_save_role_skill_info/1,get_hit_addition/1,get_soulpower/1,get_creature/1,get_items/1,get_addtion_power/1,
		clear_all_casttime/1
		]).
	...
	case SkillId of
		...
		_->
			...
			case lists:keyfind(SkillId,1, SkillList) of
				false-> case lists:member(SkillId,?PET_SKILL) of
							false ->
								0;
							true ->
								1
...
clear_all_casttime(RoleSkillInfo) ->
	SkillList = element(#role_skill.skillinfo,RoleSkillInfo),
	SkillList2 = [{SkillId, SkillLevel, {0, 0, 0}} || {SkillId, SkillLevel, _} <- SkillList],
	setelement(#role_skill.skillinfo,RoleSkillInfo,SkillList2).
