...
encode_entry_loop_instance_vote_s2c(VoteList)->
	login_pb:encode_entry_loop_instance_vote_s2c(
	  		#entry_loop_instance_vote_s2c{state = VoteList}).
...
encode_entry_loop_instance_s2c(Layer,Result,LeftTime_s,BestTime_s)->
