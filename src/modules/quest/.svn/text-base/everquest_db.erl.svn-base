...
-define(EVERQUEST_TABLE_NAME,ets_everquest_db).
...
create()->
	ets:new(?EVERQUEST_TABLE_NAME, [set,named_table]).
...
get_last_evquest(QuestInfo)->
	erlang:element(#everquests.last_evquest, QuestInfo).
