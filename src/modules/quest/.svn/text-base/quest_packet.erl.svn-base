...
-export([encode_questgiver_quest_details_s2c/3,
		 ...
		 encode_role_quest_status_s2c/1]).
...
handle(#role_quest_status_c2s{quests=Quests}, RolePid) ->
	role_processor:role_quest_status_c2s(RolePid, Quests);
...
encode_role_quest_status_s2c(Quests) ->
	login_pb:encode_role_quest_status_s2c(#role_quest_status_s2c{quests=Quests}).
%%
%% Local API
%%
