...
-export([get_itemid_by_class/1, get_itemid_with_skill/1, get_use_condition/1]).
...
get_use_condition(ItemTemplateInfo) ->
	element(#item_template.use_condition, ItemTemplateInfo).
