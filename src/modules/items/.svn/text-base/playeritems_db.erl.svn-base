...
-export([async_add_playeritems/2,add_playeritems/1,add_playeritems/2,add_playeritems/12,add_playeritems/13,
	del_playeritems/2,del_playeritems/3,async_del_playeritems/3,async_add_playeritems/13,
	mail_add_playeritems/12]).
...
mail_add_playeritems(Id,OwnerID,Entry,Enchantments,Count,Slot,Isbonded,Sockets,Duration,Cooldowninfo,Enchant,OverDueInfo) ->
	TableName = db_split:get_owner_table(playeritems, OwnerID),
	PlayerItem = {TableName,Id,OwnerID,Entry,Enchantments,Count,Slot,Isbonded,Sockets,Duration,Cooldowninfo,Enchant,OverDueInfo},
