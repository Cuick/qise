...
-export([create/0,init/0,
		 ...
		 get_autoname_used/1, clear_name_robot/0]).
...
clear_name_robot() ->
	MatchHead = #auto_name_used{name = '$1', roleid='$2',  _ = '_'},
	Guard = {'=:=', '$2', -1},
	Result = '$1',
	Fun1 = fun() -> mnesia:select(auto_name_used, [{MatchHead, [Guard], [Result]}]) end,
	{atomic, RobotNames} = mnesia:transaction(Fun1),
	Fun2 = fun() -> [mnesia:delete({auto_name_used, Key}) || Key <- RobotNames] end,
