...
%% Exported Functions
%%
-export([send_message/2,send_message_instance/4,system_broadcast/2,system_broadcast_instance/3,system_broadcast_rolelist/3,send_message_guild/3]).
			...
			case Scop of
				world->					
					case travel_battle_util:is_travel_battle_server() of
						true->
							travel_battle_util:cast_for_all_server(chat_manager,system_broadcast,[Id,Param,[]]);
						_->	
...
system_broadcast_rolelist(Id,Param,RoleList)->
    chat_manager:system_broadcast(Id,Param,{rolelist,RoleList}).
...
send_message(Id,Out)->
	case system_chat_db:get_msg_option(Id) of
		...
		OptInfo->
			...
			case Scop of
				allserver->
					travel_battle_util:cast_for_all_server(chat_manager,system_message,[Type,Out]);
				world->	
					case travel_battle_util:is_travel_battle_server() of
						true->
							travel_battle_util:cast_for_all_server(chat_manager,system_message,[Type,Out]);
