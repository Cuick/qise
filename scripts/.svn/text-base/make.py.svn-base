...
print 'python %s/../../tools/ei_compiler/mkmsg.py  --erh_out %s/../include --erl_out %s/../src/modules/protocol --proto_dir %s ' % (cwd,cwd,cwd,PROTO_PATH)
#os.system('python %s/../../tools/ei_compiler/mkmsg.py  --erh_out %s/../include --erl_out %s/../src/modules/protocol --proto_dir %s ' % (cwd,cwd,cwd,PROTO_PATH))
